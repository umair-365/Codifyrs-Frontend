...
const BetalyzerSection = () => {
  ...
  const project = {
    ...
    name: "Betalyzer",
    description:
      "Betalyzer is a comprehensive online platform designed for sports bettors and enthusiasts to compare real-time odds from multiple bookmakers, track line movements, and access detailed match statistics. It provides live scores, historical data, and betting trends, empowering users to identify value bets and make smarter betting decisions with greater accuracy.",
    images: [
      portfolio1,
      portfolio2,
      portfolio3,
    ...
    techStack: ["React", "Node.js","Django API" ,"MongoDB", "Stripe", "AWS", "Docker"],
  };
